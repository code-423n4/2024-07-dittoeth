...
contract DeployDiamond is DeployHelper {
    ...
    function run() external {
        ...
        Deployed[] memory contracts = new Deployed[](14);
        ...
        contracts[4] = Deployed("yDUSD", _yDUSD);
        contracts[5] = Deployed("bridgeReth", _bridgeReth);
        contracts[6] = Deployed("bridgeSteth", _bridgeSteth);
        contracts[7] = Deployed("diamond", _diamond);
        contracts[8] = Deployed("steth", _steth);
        contracts[9] = Deployed("ethAggregator", _ethAggregator);
        contracts[10] = Deployed("rocketStorage", _rocketStorage);
        contracts[11] = Deployed("reth", _reth);
        contracts[12] = Deployed("multicall3", _multicall3);
        contracts[13] = Deployed("unsteth", _unsteth);
