...
pragma solidity 0.8.25; // optimization enabled, 99999 runs, evm: petersburg
...
contract ImmutableCreate2Factory {
        ...
        returns (address deploymentAddress)
    {
        ...
        require(
            deploymentAddress == targetDeploymentAddress, "Failed to deploy contract using provided salt and initialization code."
        );
