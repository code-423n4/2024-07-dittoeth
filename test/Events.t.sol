...
contract EventsTest is OBFixture {
    ...
    function test_Events() public {
        ...
        vm.expectEmit(_diamond);
        emit Events.MatchOrder(_dusd, sender, O.LimitBid, uint88(DEFAULT_PRICE).mulU88(10000 ether), uint88(10000 ether));
    ...
    function test_MatchOrderEvents() public {
        ...
        vm.startPrank(sender);
        vm.expectEmit(_diamond);
        emit Events.MatchOrder(_dusd, sender, O.LimitShort, uint88(DEFAULT_PRICE).mulU88(10000 ether), uint88(10000 ether));
        ...
        vm.prank(receiver);
        vm.expectEmit(_diamond);
        emit Events.MatchOrder(_dusd, receiver, O.LimitAsk, uint88(DEFAULT_PRICE).mulU88(5000 ether), uint88(5000 ether));
