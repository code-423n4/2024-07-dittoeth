...
contract ShortsErcDebtTest is OBFixture {
    ...
    function setUp() public override {
        ...
        testFacet.setErcDebtRateAsset(asset, MULTIPLIER);
    ...
    function assertShortRecordsStillOpen(address shorter) public view {
    ...
    function assertShortRecordsClosed(address shorter) public view {
        STypes.ShortRecord memory short = getShortRecord(shorter, C.SHORT_STARTING_ID);
