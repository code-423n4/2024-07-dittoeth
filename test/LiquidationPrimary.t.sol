...
contract PrimaryLiquidationTest is LiquidationHelper {
    ...
    */
        ...
        returns (LiquidationStruct memory m, STypes.ShortRecord memory shortRecord)
    {
        ...
        uint88 ercMintedFromAsk = DEFAULT_AMOUNT;
        prepareAsk({askPrice: DEFAULT_PRICE, askAmount: ercMintedFromAsk});
    ...
    function test_PrimaryFullLiquidateCratioScenario2A() public {
        ...
        checkShortsAndAssetBalance({
            ...
            _collateral: 0,
            _ercDebt: 0,
            _ercDebtAsset: ercMintedFromAsk,
            _ercDebtRateAsset: 0,
            _ercAsset: DEFAULT_AMOUNT //1 from short minting
        });
    }
    ...
    function test_PrimaryFullLiquidateCratioScenario3A() public {
        ...
        checkShortsAndAssetBalance({
            ...
            _collateral: 0,
            _ercDebt: 0,
            _ercDebtAsset: m.ercDebtSocialized + DEFAULT_AMOUNT + ercMintedFromAsk, // 1 from dummy short + 1 minted from ask
        ...
        returns (LiquidationStruct memory m, STypes.ShortRecord memory shortRecord)
    {
        ...
        //Check updatedAt
        if (scenario == PrimaryScenarios.CRatioBetween110And200) {
            // @dev shorter's SR should be updated for time of partial liquidation
            assertEq(shortRecord.updatedAt, uint32(diamond.getOffsetTime()));
        } else {
            // @dev tapp's SR should be updated for time of partial liquidation, but shorter's SR should be deleted
            assertEq(shortRecord.updatedAt, initialUpdatedAt);
            assertTrue(shortRecord.status == SR.Closed);
            getShortRecord(tapp, C.SHORT_STARTING_ID).updatedAt = uint32(diamond.getOffsetTime());
        }
    }
    ...
    function test_PrimaryPartialLiquidateCratioScenario1() public {
        ...
        checkShortsAndAssetBalance({
            ...
            _ercDebtAsset: DEFAULT_AMOUNT.mulU88(0.5 ether) + ercMintedFromAsk,
            _ercDebtRateAsset: 0,
            _ercAsset: DEFAULT_AMOUNT //1 from short minting
        });
    }
    ...
    function test_PrimaryPartialLiquidateCratioScenario3() public {
        ...
        checkShortsAndAssetBalance({
            ...
            _ercDebtAsset: DEFAULT_AMOUNT.mulU88(0.5 ether) + DEFAULT_AMOUNT + ercMintedFromAsk, // 0.5 from tapp short, 1 from dummy short, 1 from ask
            _ercDebtRateAsset: m.ercDebtRate,
            _ercAsset: DEFAULT_AMOUNT //1 from short minting
        });
    }
    ...
    function test_PrimaryPartialLiquidateCratioScenario3CalledBytapp() public {
        ...
        checkShortsAndAssetBalance({
            ...
            _ercDebtAsset: DEFAULT_AMOUNT.mulU88(0.5 ether) + DEFAULT_AMOUNT + ercMintedFromAsk, // 0.5 from tapp short, 1 from dummy short
            _ercDebtRateAsset: m.ercDebtRate,
            _ercAsset: DEFAULT_AMOUNT //1 from short minting
        });
    }
    ...
    function secondFullyLiquidateShortPrimary(
        ...
        STypes.ShortRecord memory shortTAPP = getShortRecord(tapp, C.SHORT_STARTING_ID);
        vm.stopPrank();
        ...
        if (scenario == PrimaryScenarios.CRatioBetween110And200) {
            ...
            if (caller == receiver) {
                t.ethEscrowed = FUNDED_TAPP + tappFee1 - m.ethFilled - m.gasFee - m.callerFee + shortTAPP.collateral;
                //including fee gained from partial fill
                s.ethEscrowed = 0; //lose all collateral
                r.ethEscrowed = (ethFilled1 + m.ethFilled) + (callerFee1 + m.callerFee) + (gasFee1 + m.gasFee); //including fee gained from partial fill
            } else if (caller == sender) {
                t.ethEscrowed =
                    FUNDED_TAPP + tappFee1 + gasFee1 + callerFee1 - m.ethFilled - m.gasFee - m.callerFee + shortTAPP.collateral;
    ...
    function test_PrimaryPartialThenFullyLiquidateCratioScenario1() public {
        ...
        // @dev secondFullyLiquidateShortPrimary calls another fundLimitAsk
        ercMintedFromAsk += DEFAULT_AMOUNT.mulU88(0.5 ether);
        //check balance after liquidate
        checkShortsAndAssetBalance({
            _shorter: sender,
            _shortLen: 0,
    ...
    function test_PrimaryPartialThenPartialLiquidateCratioScenario2() public {
        ...
        // @dev secondFullyLiquidateShortPrimary calls another fundLimitAsk
        ercMintedFromAsk += DEFAULT_AMOUNT.mulU88(0.1 ether);
        ...
        checkShortsAndAssetBalance({
            ...
            _ercDebtAsset: DEFAULT_AMOUNT.mulU88(0.4 ether) + ercMintedFromAsk,
            _ercDebtRateAsset: 0,
            _ercAsset: DEFAULT_AMOUNT //1 from short minting
        });
    }
    ...
    function test_LiquidateUsdLesslowestSellUsd() public {
        uint88 ercMintedFromAsk = DEFAULT_AMOUNT.mulU88(2 ether);
        ...
        checkShortsAndAssetBalance({
            ...
            _collateral: DEFAULT_PRICE.mulU88(DEFAULT_AMOUNT).mul(6 ether),
            _ercDebt: DEFAULT_AMOUNT.mulU88(1 ether),
            _ercDebtAsset: DEFAULT_AMOUNT.mulU88(1 ether) + ercMintedFromAsk,
            _ercDebtRateAsset: 0,
    ...
    function test_LiquidateOBSuddenlyEmpty() public {
        uint88 ercMintedFromAsk = DEFAULT_AMOUNT.mulU88(0.5 ether);
        prepareAsk(DEFAULT_PRICE, ercMintedFromAsk);
        depositEth(tapp, DEFAULT_TAPP);
    ...
    function test_PrimaryFullLiquidateCratioScenario2CRatioUnder1() public {
        ...
        uint88 ercMintedFromAsk = DEFAULT_AMOUNT;
        fundLimitAskOpt(askPrice, ercMintedFromAsk, receiver);
    ...
    function test_PrimaryLiquidation_TappSRExcludedFromSocialization() public {
        ...
        assertEq(diamond.getAssetStruct(asset).ercDebtRate, tappSR.ercDebtRate);

        fullyLiquidateShortPrimaryScenarioA({scenario: PrimaryScenarios.CRatioBelow110BlackSwan, caller: receiver});

        // @dev tappSR.ercDebtRAte equals to Asset.ercDebtRate at moment of liquidation in cases of socialization.
        tappSR = getShortRecord(tapp, C.SHORT_STARTING_ID);
        assertEq(tappSR.ercDebt, 0);
        assertGt(tappSR.ercDebtRate, 0); //non-zero
        assertEq(diamond.getAssetStruct(asset).ercDebtRate, tappSR.ercDebtRate);
    }
}
