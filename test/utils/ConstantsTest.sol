...
abstract contract ConstantsTest is Test {
    ...
    uint256 public constant MAX_DELTA_MEDIUM = 1000000;
    ...
    uint256 public constant MAX_REDEMPTION_DEADLINE = type(uint256).max;
    uint88 public constant ERCDEBTSEED = DEFAULT_AMOUNT * 10000;
