...
contract SellOrdersTest is OBFixture {
    ...
    function checkEscrowedAndOrders(
        ...
        // Asset level ercDebt
        assertEq(diamond.getAssetStruct(asset).ercDebt, ercMintedFromAsk);
    }
    ...
    function test_AddingLimitSellAskUsdGreaterThanBidUsd() public {
        ...
        checkEscrowedAndOrders({
            ...
            bidLength: 0,
            askLength: 1,
            ercMintedFromAsk: DEFAULT_AMOUNT * 2
        });
    ...
    function test_AddingLimitSellAskWithMultipleBids() public {
        ...
        checkEscrowedAndOrders({
            ...
            bidLength: 1,
            askLength: 0,
            ercMintedFromAsk: DEFAULT_AMOUNT
        });
    ...
    function test_AddingSellUsdLessThanBidUsd2() public {
        ...
        checkEscrowedAndOrders({
            ...
            bidLength: 1,
            askLength: 0,
            ercMintedFromAsk: DEFAULT_AMOUNT.mulU88(1.5 ether)
        });
    ...
    function test_AddingSellUsdLessThanBidUsdUntilBidIsFullyFilled() public {
        ...
        checkEscrowedAndOrders({
            ...
            bidLength: 0,
            askLength: 0,
            ercMintedFromAsk: DEFAULT_AMOUNT.mulU88(1.5 ether) + DEFAULT_AMOUNT.mulU88(3.5 ether)
        });
    }
    ...
    function test_PartialLimitAsk() public {
        ...
        checkEscrowedAndOrders({
            ...
            bidLength: 1,
            askLength: 1,
            ercMintedFromAsk: DEFAULT_AMOUNT.mulU88(3.5 ether)
        });
    }
    ...
    function test_PartialMarketAskOBSuddenlyEmpty() public {
        ...
        checkEscrowedAndOrders({
            ...
            bidLength: 0,
            askLength: 0,
            ercMintedFromAsk: DEFAULT_AMOUNT * 4
        });
    }
