...
contract InactiveOrdersTest is OBFixture {
    ...
    function test_OrderIdBids() public {
        assertEq(diamond.getAssetStruct(asset).orderIdCounter, 100);
        fundLimitBidOpt(4 ether, 1 ether, receiver);
        assertEq(diamond.getAssetStruct(asset).orderIdCounter, 101);
        ...
        assertEq(diamond.getAssetStruct(asset).orderIdCounter, 102);
        ...
        assertEq(diamond.getAssetStruct(asset).orderIdCounter, 103);
    }

    function test_CancelInactiveBidOrders() public {
        fundLimitBidOpt(4 ether, 1 ether, receiver);
    ...
    function test_OrderIdAsks() public {
        assertEq(diamond.getAssetStruct(asset).orderIdCounter, 100);
    ...
    function test_CancelInactiveAskOrders() public {
        assertEq(diamond.getAssetStruct(asset).orderIdCounter, 100);
