...
contract InvariantsOrderBook is InvariantsBase {
    ...
    function statefulFuzz_basic() public view {
        boundTest();
        orderIdGtMarketDepth();
        // oracleTimeAlwaysIncrease(); // @dev This is failing but not sure it should..
        startingShortPriceGteOraclePrice();
        shortRecordCounterLtShortMaxId();
        dittoMatchedShares();
        // dittoShorterReward(); // @dev Fails sometimes bc of non-uniform yield distribution
        dethCollateralRewardAlwaysIncrease();
        dethYieldRateAlwaysIncrease();
        titheBetween10And100();
    }
