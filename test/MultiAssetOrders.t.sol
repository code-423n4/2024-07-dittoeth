...
contract MultiAssetOrdersTest is OBFixture {
    ...
    function test_MultiAssetSettings() public view {
        ...
        assertEq(diamond.getAssetNormalizedStruct(asset).discountPenaltyFee, 0.001 ether);
        ...
        assertEq(diamond.getAssetStruct(_cgld).discountPenaltyFee, 10);
        ...
        assertEq(diamond.getAssetNormalizedStruct(_cgld).discountPenaltyFee, 0.001 ether);
    }
