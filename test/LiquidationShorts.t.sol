...
contract LiquidationShortsTest is LiquidationGeneralTest {
    ...
    function test_PrimaryFullLiquidateCratioScenario1FromShort() public {
        fullyLiquidateShortPrimary({scenario: PrimaryScenarios.CRatioBetween110And200, caller: receiver});
    ...
    function test_PrimaryFullLiquidateCratioScenario1CalledByTappFromShort() public {
        fullyLiquidateShortPrimary({scenario: PrimaryScenarios.CRatioBetween110And200, caller: tapp});
    ...
    function test_PrimaryFullLiquidateCratioScenario2CalledByTappFromShort() public {
        fullyLiquidateShortPrimary({scenario: PrimaryScenarios.CRatioBelow110, caller: tapp});
