...
contract BuyFromSelfTest is OBFixture {
    ...
    function test_AddingLimitBidPriceEqualShortPriceSelf() public {
    ...
    function test_AddingMarketBidUsdEqualShortUsdSelf() public {
        fundLimitShortOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
    ...
    function test_AddingMarketBidUsdEqualSellUsdSelf() public {
    ...
    function test_AddingMarketBidUsdGreaterShortUsdSelf() public {
        fundLimitShortOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        (, uint256 ercAmountLeft) = fundMarketBid(DEFAULT_PRICE, DEFAULT_AMOUNT.mulU88(2 ether), receiver);
    ...
    function test_AddingMarketBidUsdGreaterSellUsdSelf() public {
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        (, uint256 ercAmountLeft) = fundMarketBid(DEFAULT_PRICE, DEFAULT_AMOUNT.mulU88(2 ether), receiver);
        assertEq(ercAmountLeft, DEFAULT_AMOUNT);
    ...
    function test_AddingMarketBidUsdLessShortUsdSelf() public {
        ...
        assertEq(shorts[0].ercAmount.mul(shorts[0].price), DEFAULT_PRICE.mulU88(DEFAULT_AMOUNT));
    ...
    function test_AddingMarketBidUsdLessSellUsdSelf() public {
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT.mulU88(2 ether), receiver);
        fundMarketBid(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        STypes.Order[] memory asks = getAsks();
        assertEq(asks[0].ercAmount, DEFAULT_AMOUNT);
        assertEq(asks[0].ercAmount.mul(asks[0].price), DEFAULT_PRICE.mulU88(DEFAULT_AMOUNT));
    ...
    function test_AddingLimitBidWithMultipleShortsSelf() public {
        fundLimitShortOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        fundLimitShortOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        (, uint256 ercAmountLeft) = fundLimitBidOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        assertEq(ercAmountLeft, 0);
    ...
    function test_AddingLimitBidWithMultipleSellsSelf() public {
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        (, uint256 ercAmountLeft) = fundLimitBidOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        assertEq(ercAmountLeft, 0);
    ...
    //partial fills
    function test_AddingBidUsdLessThanShortAskUsdSelf() public {
        fundLimitShortOpt(DEFAULT_PRICE, DEFAULT_AMOUNT.mulU88(2 ether), receiver);
        (, uint256 ercAmountLeft) = fundLimitBidOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
    ...
    function test_AddingBidUsdLessThanSellAskUsdSelf() public {
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT.mulU88(2 ether), receiver);
        (, uint256 ercAmountLeft) = fundLimitBidOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        assertEq(ercAmountLeft, 0);
    ...
    function test_PartialMarketBuyDueToInsufficientAsksOnOBSelf() public {
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        (, uint256 ercAmountLeft) = fundMarketBid(DEFAULT_PRICE, DEFAULT_AMOUNT.mulU88(2 ether), receiver);
        assertEq(ercAmountLeft, DEFAULT_AMOUNT);
    ...
    function test_MarketBuyOutOfPriceRangeSelf() public {
    ...
    function test_PartialMarketBuyUpUntilPriceRangeFillSelf() public {
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        ...
        (, uint256 ercAmountLeft) = fundMarketBid(DEFAULT_PRICE, DEFAULT_AMOUNT.mulU88(4 ether), receiver);
    ...
    function test_CorrectIncomingBidUpdateOnMatchingPartialAskFillSelf() public {
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
    ...
    function test_CorrectIncomingBidUpdateOnMatchingPutOnOBSelf() public {
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        fundLimitAskOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver);
        fundLimitAskOpt(DEFAULT_PRICE * 2, DEFAULT_AMOUNT, receiver);
