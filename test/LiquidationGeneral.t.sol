...
import {U256, U128, U104, U88, U80} from "contracts/libraries/PRBMathHelper.sol";
...
contract LiquidationGeneralTest is LiquidationHelper {
    ...
    function test_LiquidateForcedBidFee() public {
        ...
        uint88 ercMintedFromAsk = DEFAULT_AMOUNT.mulU88(0.5 ether) * 10;
        ...
        checkShortsAndAssetBalance({
            ...
            _ercDebtAsset: DEFAULT_AMOUNT + ercMintedFromAsk,
            _ercDebtRateAsset: 0,
    ...
    function marketShutdown(int256 ethPrice) public {
        ...
        // randomAddr deposits and then redeems from escrow
        assertEq(diamond.getVaultUserStruct(vault, randomAddr).ethEscrowed, 0);
        vm.prank(randomAddr);
        diamond.depositAsset(asset, DEFAULT_AMOUNT);
        redeemErc(0, DEFAULT_AMOUNT, randomAddr);
        assertEq(diamond.getVaultUserStruct(vault, extra).ethEscrowed, ercAmount);
    }
