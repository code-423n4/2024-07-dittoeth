...
contract MockAggregatorV3 is AggregatorV3Interface {
    ...
    function setRoundData(uint80 roundId, int256 answer, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound) external {
    ...
    function latestRoundData()
        ...
        returns (uint80 roundId, int256 answer, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound)
    {
        if (isFailing) revert ChainlinkFail();
    ...
    function setFail(bool isFail) external {
        isFailing = isFail;
    }
}
