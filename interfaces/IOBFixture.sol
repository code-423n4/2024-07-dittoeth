...
interface IOBFixture {
  ...
  function randomAddr() external view returns (address);
  function receiver() external view returns (address);
  function sender() external view returns (address);
  function extra() external view returns (address);
  function extra2() external view returns (address);
  ...
  function initialCR() external view returns (uint16);
  ...
  function liquidate(address shorter, uint8 id, address account) external returns (uint256 fillEth);
  function liquidateErcEscrowed(address shorter, uint8 id, uint88 amount, address account) external;
