...
contract GasCreate is GasFund {
    ...
    function testGas_CreateBid() public {
    ...
    function testGas_CreateShort() public {
    ...
    function testGas_CreateShort_CapitalEfficient() public {
        uint16[] memory shortHintArray = createShortHintArrayGas({shortHint: DEFAULT_SHORT_HINT_ID});
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(receiver);
        startMeasuringGas("Order-CreateShort-New-CapitalEfficient");
        diamond.createLimitShort(_asset, DEFAULT_PRICE, DEFAULT_AMOUNT, orderHintArray, shortHintArray, initialCR - 1);
        stopMeasuringGas();
        assertEq(ob.getShorts().length, 1);
    }
}
...
contract GasCancelAsk is GasFund {
    function setUp() public virtual override {
        super.setUp();
...
contract GasCancelBid is GasFund {
    function setUp() public virtual override {
        super.setUp();
...
contract GasCancelShort is GasFund {
    function setUp() public virtual override {
        super.setUp();
...
contract GasCancelShortPartialFill is GasFund {
    function setUp() public virtual override {
        super.setUp();
    ...
    function testGas_testGas_CancelShortPartialFill() public {
        address _asset = asset;
        vm.prank(receiver);
...
contract GasCancelShortAfterPartialFillCancelled is GasFund {
    function setUp() public virtual override {
        super.setUp();
        uint88 minShortErc = uint88(diamond.getMinShortErc(asset));
        ob.fundLimitShortOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver); // 100
...
contract GasCancelShortUnderMinShortErc is GasFund {
    function setUp() public virtual override {
        super.setUp();
        uint88 minShortErc = uint88(diamond.getMinShortErc(asset));
        ob.fundLimitShortOpt(DEFAULT_PRICE, DEFAULT_AMOUNT, receiver); // 100
...
contract GasCancelShortCapitalEfficient is GasFund {
    function setUp() public virtual override {
        super.setUp();
        ...
        diamond.createLimitShort(asset, DEFAULT_PRICE, DEFAULT_AMOUNT, orderHintArray, shortHintArray, initialCR - 1); // 100
        diamond.createLimitShort(asset, DEFAULT_PRICE, DEFAULT_AMOUNT, orderHintArray, shortHintArray, initialCR - 1); // 101
        diamond.createLimitShort(asset, DEFAULT_PRICE, DEFAULT_AMOUNT, orderHintArray, shortHintArray, initialCR - 1); // 102
        vm.stopPrank();
    }

    function testGas_CancelShortCapitalEfficient() public {
        address _asset = asset;
        vm.prank(receiver);
        startMeasuringGas("Order-CancelShort-CapitalEfficient");
        diamond.cancelShort(_asset, 100);
        stopMeasuringGas();
        assertEq(ob.getShorts().length, 2);
    }
...
contract GasPlaceBidOnObWithHintTest is GasFund {
    function setUp() public virtual override {
        super.setUp();
    ...
    function testGas_CreateAskOrderHintOffForward1() public {
        uint16[] memory shortHintArray = createShortHintArrayGas({shortHint: ONE});
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(receiver);
    ...
    function testGas_CreateAskOrderHintOffBack1() public {
        uint16[] memory shortHintArray = createShortHintArrayGas({shortHint: ONE});
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(receiver);
    ...
    function testGas_CreateBidIncomingIsBestPrice() public {
        uint16[] memory shortHintArray = createShortHintArrayGas({shortHint: ONE});
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(receiver);
    ...
    function testGas_CreateBidIncomingIsNotBestPrice() public {
        uint16[] memory shortHintArray = createShortHintArrayGas({shortHint: ONE});
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(receiver);
...
contract GasPlaceAskOnObWithHintTest is GasFund {
    function setUp() public virtual override {
        super.setUp();
    ...
    function testGas_CreateAskIncomingIsBestPrice() public {
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(sender);
    ...
    function testGas_CreateAskIncomingIsNotBestPrice() public {
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(sender);
...
contract GasPlaceShortOnObWithHintTest is GasFund {
    function setUp() public virtual override {
        super.setUp();
    ...
    function testGas_CreateShortIncomingIsBestPrice() public {
        uint16[] memory shortHintArray = createShortHintArrayGas({shortHint: ONE});
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(sender);
    ...
    function testGas_CreateShortIncomingIsNotBestPrice() public {
        uint16[] memory shortHintArray = createShortHintArrayGas({shortHint: ONE});
        MTypes.OrderHint[] memory orderHintArray = createOrderHintArrayGas();
        address _asset = asset;
        vm.prank(sender);
...
contract GasCancelBidFarFromHead is GasFund {
...
contract GasCancelAskFarFromHead is GasFund {
    using U256 for uint256;
...
contract GasCancelShortFarFromHead is GasFund {
    using U256 for uint256;
